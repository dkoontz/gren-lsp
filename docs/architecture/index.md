...
- [Gren LSP Server Architecture](#table-of-contents)
  ...
  - [Tech Stack](./tech-stack.md)
    ...
    - [Architecture Rationale](./tech-stack.md#architecture-rationale)
  - [Coding Standards](./coding-standards.md)
    ...
    - [Testing Requirements](./coding-standards.md#testing-requirements)
  - [Source Tree Structure](./source-tree.md)
    - [Project Root Structure](./source-tree.md#project-root-structure)
    - [Component Organization](./source-tree.md#component-organization-rationale)
    - [Build System Integration](./source-tree.md#build-system-integration)
